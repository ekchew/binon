...
class CodeByte:
    ...
    to False for the sake of conditional expressions. So it would be False for
    a bool, 0 for an int, "" for a str, [] for a list, and so forth.
    ...
    Class Attributes:
        ...
        kBaseSubtype (1): subtype indicating an unspecialized base type
            ...
            equates for these are defined in other ...obj modules since they
            are context-dependent on the base type.
    ...
    def BaseSubtypes(cls):
        """
        Simply returns the two subtypes associated with the base object class
        in tuple form. (This is used interally by the object classes in
        registering themselves into BinONObj's internal database.)
