...
class IDGen:
    ...
    a tighter encoding for smaller integers that larger ones, and IDGen tries
    to keep them small by recycling IDs that are no longer in use.
    ...
    def acquire(self):
        """
        If you prefer not to use an iterator, you can acquire new IDs by
        calling this method.
