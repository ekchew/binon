...
namespace binon {
	//	The BoolObj struct is conceptually simple but has some quirks. For
	//	example, the encodeData() and decodeData() methods are normally never
	...
	//	   straight into the code byte (as either a default (false) BoolObj or a
	//	   TrueObj, in BinON parlance).
